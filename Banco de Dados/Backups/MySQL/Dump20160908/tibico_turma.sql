...
CREATE TABLE `turma` (
  ...
  KEY `calendario_turma_fk` (`horario_id`),
  KEY `disciplina_turma_fk` (`disciplina_id`),
  CONSTRAINT `calendario_turma_fk` FOREIGN KEY (`horario_id`) REFERENCES `calendario` (`horario_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
